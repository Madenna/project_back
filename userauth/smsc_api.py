...
SMSC_LOGIN = "madenna"					# логин клиента
SMSC_PASSWORD = "Madenna!2003"				# пароль клиента. Если передан пустой логин, то SMSC_PASSWORD используется, как API ключ, вместо логина и пароля
